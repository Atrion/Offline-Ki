...
def OnCommand(ki, command, playerList, KIContent, silent):
    try:
        ...
        if (parts[0].lower() == 'info'):
            ...
            ki.IDoStatusChatMessage('Also containing contributions by Agenotfound, Almlys, a\'moaca\', Ashtar, cjkelly1, DarkFalkon, D\'Lanor, Dustin, GPNMilano, H\'astin, Hoikas, Kaelis Ebonrai, Zrax and unknown AdminKI and UserKI programmers', netPropagate=0)
            return True
        # relay event
