...
# uhhh... warping between the hut and the sphere can make for very, very
# long camera pulls in third person
...
#Kickable pieces of wood in the Ferry Cave
        'cavewood' : ('FerryCaveObject35','FerryCaveObject37','FerryCaveObject38','FerryCaveObject39','FerryCaveObject40'),
...
#   CAVE:
        'cavestones' : ('FerryCaveObject35','FerryCaveObject37','FerryCaveObject38', 'FerryCaveObject39','FerryCaveObject40'),
        },
...
#removers, excess sounds etc.
    ...
    'Neighborhood' : {
        ...
        'hoodfire' : ('MarblePhy01','MarblePhy02','MarblePhy03','MarblePhy04','MarblePhy06','MarblePhy07','MarblePhy08'),
...
#These work with the new /circle /line commands too
...
#Using the /drawon and /drawoff commands, you can use the following to remove
#the fountain in the hood
...
#By Greypiffle to be used with the new /treeson (in the funstuff) and the
#/drawon command
...
# Turns one of the Kadish Gallery doors into a diving board
        #'divingboard' : ([['KdshGalleryDoor01'],[-0.069735,0.034878,0.996956],[0.374824,0.927075,-0.006215],[174.711212,-322.800354,178.895203]],),
...
#TPOTS [['smokeemitter01'],[0.000000,-0.788011,-0.615662],[0.000000,-0.615662,0.788011],[21.393028,185.388245,478.887451]],
#TPOTS [['smokeemitter02'],[-0.190051,-0.791621,-0.580703],[-0.135562,-0.564658,0.814115],[-23.564562,171.555710,478.887451]],
...
#TPOTS [['FerryCaveObject35'],[0.853079,-0.519784,-0.045611],[-0.024855,0.046834,-0.998594],[129.146759,-566.673523,7.118889]],
#TPOTS [['FerryCaveObject37'],[0.483207,-0.875024,0.029048],[-0.283263,-0.124858,0.950880],[137.963608,-577.792969,7.099597]],
#TPOTS [['FerryCaveObject38'],[-0.861852,-0.505059,-0.046129],[0.056044,-0.004447,-0.998419],[144.245087,-572.977905,7.126432]],
#TPOTS [['FerryCaveObject39'],[-0.965184,0.257332,-0.046910],[0.041043,-0.028125,-0.998762],[135.387817,-576.043823,7.123857]],
#TPOTS [['FerryCaveObject40'],[-0.534388,0.844238,-0.041146],[-0.001085,-0.049364,-0.998781],[140.170456,-577.076904,7.126588]],
...
#TPOTS [['smokeemitter01'],[0.000000,-0.788011,-0.615662],[0.000000,-0.615662,0.788011],[-70.600494,-99.382484,255.673111]],
#TPOTS [['smokeemitter02'],[-0.190051,-0.791621,-0.580703],[-0.135562,-0.564658,0.814115],[-72.600494,-103.382484,247.673111]]
),
...
#TPOTS [['SmokeEmitter01'],[0.000000,-0.989172,-0.146764],[0.000000,-0.146764,0.989172],[721.455261,-486.344727,267.670410]]
),
...
#TPOTS [['SmokeEmitter01'],[0.000000,-0.989172,-0.146764],[0.000000,-0.146764,0.989172],[21.377424,-92.813759,334.944214]],
#TPOTS [['SmokeEmitter02'],[-0.190051,-0.791621,-0.580703],[-0.135562,-0.564659,0.814115],[11.377424,-92.813759,336.944214]],
...
# You can "Link" someone to center stage by using /flink ferrycaveobject37
# they will be center stage facing the audience when finished.
...
#TPOTS [['ferrycaveobject38'],[-1.574939,-11.927046,0.319129],[0.044153,0.347181,4.993462],[-69.514801,-76.095749,221.643234],[15,12,5]],
#TPOTS [['ferrycaveobject39'],[-0.998018,-0.043456,-0.045517],[0.046447,-0.020645,-0.998708],[-72.829399,-64.246567,222.363113]],
#TPOTS [['ferrycaveobject40'],[-0.961989,0.270191,-0.039662],[0.027507,-0.048627,-0.998438],[-71.291389,-64.060966,222.269821]],
...
#TPOTS [['ferrycaveobject37'],[0.991860,-0.127314,-0.002206],[0.005659,0.026769,0.999626],[-69.514786,-76.095749,222.443253]]
),
...
[['OrangeCone'],[0.965867,0.259037,0.000836],[-0.000197,-0.002493,0.999997],[110.203896,-155.200897,216.296722]]),
    ...
    #'GreatZero' : {
##use /struct casino to place the marker machines at their new location 
##they work if your marker level is high enough
        #'casino' : ([['GZMachine01'],[-0.573576,-0.819152,0.000000],[0.000000,0.000000,1.000000],[47.268578,-24.014175,-35.533695]],
#[['GZMachine02'],[-0.615661,0.788011,-0.000000],[-0.000000,0.000000,1.000000],[-260.000000,229.000000,-16.500000]],
#[['GZMachine03'],[0.559193,-0.829038,0.000000],[0.000000,0.000000,1.000000],[47.467930,24.442520,-35.533695]],
#[['GZMachine04'],[0.642788,0.766044,0.000000],[0.000000,0.000000,1.000000],[-47.531116,24.338772,-35.533695]]),
    #},
...
#TPOTS [['MarblePhy01'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,1.000000],[253.286774,-789.376770,4.617686]],
#TPOTS [['MarblePhy02'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,1.000000],[256.539459,-789.376770,4.617686]],
#TPOTS [['MarblePhy03'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,1.000000],[250.126129,-789.376770,4.617686]],
#TPOTS [['MarblePhy04'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,1.000000],[246.774765,-789.376770,4.617686]],
...
#TPOTS [['MarblePhy04'],[-0.118939,-0.981481,0.150164],[0.668879,0.032568,0.742658],[280.228668,-796.952759,12.576600]]
),
...
#TPOTS [['MarblePhy01'],[-0.009315,-0.999957,0.000000],[0.000000,0.000000,1.000000],[280.025818,-796.950562,15.641022]],
#TPOTS [['MarblePhy02'],[-0.009315,-0.999957,0.000000],[0.000000,0.000000,1.000000],[280.025818,-796.950562,15.641022]],
#TPOTS [['MarblePhy03'],[-0.009315,-0.999957,0.000000],[0.000000,0.000000,1.000000],[280.025818,-796.950562,15.641022]],
#TPOTS [['MarblePhy04'],[-0.009315,-0.999957,0.000000],[0.000000,0.000000,1.000000],[280.025818,-796.950562,15.641022]],
...
#TPOTS  [['marblephy01'],[-4.522032,-11.715692,21.616982],[21.902407,8.068461,8.954579],[277.997192,-797.318176,14.537071],[25,25 ,25]],
#TPOTS  [['marblephy04'],[0.000000,-31.000000,0.000000],[0.000000,0.000000,31.000000],[280.207489,-796.358948,10.981453],[30,30,30]]
 ),
...
[['OrangeCone01'],[3.649006,1.638459,0.014310],[-0.007892,-0.017359,3.999955],[280.919861,-796.963074,19.017250],[4.000000,4.000000,4.000000]]),
        'fountainbeams' : (#TPOTS [['MarblePhy01'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,20.000000],[286.382568,-789.082947,9.138309],[1.000000,1.000000,20.000000]],
#TPOTS [['MarblePhy02'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,20.000000],[277.922424,-787.151978,9.138309],[1.000000,1.000000,20.000000]],
#TPOTS [['MarblePhy03'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,20.000000],[271.137970,-792.562439,9.138309],[1.000000,1.000000,20.000000]],
#TPOTS [['MarblePhy04'],[0.000000,-1.000000,0.000000],[0.000000,0.000000,20.000000],[271.138031,-801.240173,9.138309],[1.000000,1.000000,20.000000]],
...
#TPOTS [['marblephy03'],[-0.654689,-2.927692,0.000000],[0.000000,0.000000,10000.000000],[279.913605,-796.871521,9.405395],[3,3,10000]],
#TPOTS [['marblephy01'],[-1.527607,-6.831282,0.000000],[0.000000,0.000000,7.000000],[279.913605,-796.871521,21.905396],[7,7,7]],
#TPOTS [['marblephy02'],[-0.654689,-2.927692,0.000000],[0.000000,0.000000,10000.000000],[279.913605,-796.871521,9.405395],[25000,.1,.1]],
#TPOTS [['marblephy04'],[-6.546890,-29.276926,0.000000],[0.000000,0.000000,0.100000],[279.913605,-796.871521,5.405395],[30,30,.1]],
...
#TPOTS         'yfloor' : ([['marblephy01'],[0.663848,0.747868,-0.000000],[0.747868,-0.663848,0.000000],[279.404236,-796.903442,2.566596],[60,60,1]],),
#TPOTS         'wfloor' : ([['marblephy02'],[0.663848,0.747868,-0.000000],[0.747868,-0.663848,0.000000],[279.404236,-796.903442,2.566596],[60,60,1]],),
#TPOTS         'bfloor' : ([['marblephy03'],[0.663848,0.747868,-0.000000],[0.747868,-0.663848,0.000000],[279.404236,-796.903442,2.566596],[60,60,1]],),
#TPOTS         'rfloor' : ([['marblephy04'],[0.663848,0.747868,-0.000000],[0.747868,-0.663848,0.000000],[279.404236,-796.903442,2.566596],[60,60,1]],),
...
#TPOTS [['MarblePhy01'],[0.000000,-5.000000,0.000000],[0.000000,0.000000,5.000000],[282.949860,-792.937134,32.607315],[5,5,5]],
#TPOTS [['MarblePhy02'],[0.000000,-5.000000,0.000000],[0.000000,0.000000,5.000000],[278.719788,-791.971680,32.607315],[5,5,5]],
#TPOTS [['MarblePhy03'],[0.000000,-5.000000,0.000000],[0.000000,0.000000,5.000000],[275.327576,-794.676941,32.607315],[5,5,5]],
#TPOTS [['MarblePhy04'],[0.000000,-5.000000,0.000000],[0.000000,0.000000,5.000000],[275.327606,-799.015747,32.607315],[5,5,5]],
...
# a longer dance
    ...
    'dance2' : (['MaleDanceMOUL','MaleDanceMOUL'],['FemaleDance','FemaleDanceMOUL']),
# longer dance that makes males do the female dance and vice versa
    'trandance' : (['FemaleDance','FemaleDance'],['MaleDance','MaleDance']),
    'trandance2' : (['FemaleDanceMOUL','FemaleDanceMOUL'],['MaleDanceMOUL','MaleDanceMOUL']),
