...
class psnlVaultSDLBoolShowHide(ptMultiModifier,):
    ...
    def OnFirstUpdate(self):
        ...
        try:
            ...
            if ((type(stringVarName.value) == type('')) and (stringVarName.value != '')):
                ...
                PtDebugPrint(('ERROR: psnlVaultSDLBoolShowHide.IFinishInit():\tERROR: missing SDL var name on %s' % self.sceneobject.getName()))
                self.runDefault()
        except:
            self.runDefault()
    ...
    def runDefault(self):
        PtDebugPrint('ERROR: psnlVaultSDLBoolShowHide: running internal default')
