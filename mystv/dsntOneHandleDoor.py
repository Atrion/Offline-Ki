...
class dsntOneHandleDoor(ptResponder):
    ...
    def OnServerInitComplete(self):
        ...
        PtFindSceneobject('PinDoor05', 'DescentMystV').draw.disable() # This is required to prevent the door from being visible in the tunnel below it. It makes running the responder obsolete.
        PtFindSceneobject('shaftdoorxrgn', 'DescentMystV').physics.suppress(1) # there is nothing drawn for this
