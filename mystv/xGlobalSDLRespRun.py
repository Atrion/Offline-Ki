...
class xGlobalSDLRespRun(ptModifier):
    ...
    def OnServerInitComplete(self):
        if strRunStates.value == "1" and sdlVar.value in ["global.Laki.boolFrontDoor", "global.Laki.boolMazeDoor1", "global.Laki.boolMazeDoor2"]:
            respRunner.run(self.key, fastforward=1)
