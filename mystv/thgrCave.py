...
sdlSlate = ptAttribString(4, 'SDL: have slate')
actAtBottom = ptAttribActivator(5, 'rgn: fell to bottom (novice)')
objWarpPlayer = ptAttribSceneobject(6, 'obj: warp point for Player')
actCrackBahro = ptAttribActivator(7, 'rgn snsr: crack for Bahro')
...
class thgrCave(ptResponder):
    ...
    def OnServerInitComplete(self):
        print 'thgrCave: onserverinitcomplete'
