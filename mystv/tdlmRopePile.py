...
class tdlmRopePile(ptResponder):
    ...
    def OnServerInitComplete(self):
        print 'tdlmRopePile: OnServerInitComplete'
        ropePile = ['RedRope', 'CablePileBottom', 'GreenRope', 'CablePileTop', 'CablePileHanging02', 'CablePileHanging01']
        for obj in ropePile: PtFindSceneobject(obj, 'Todelmer').draw.disable()
